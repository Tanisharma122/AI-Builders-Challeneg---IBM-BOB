...
const pillars = [
  {
    icon: Cpu,
    title: 'Multimodal LLM reasoning',
    desc: 'Powered by IBM watsonx.ai and Granite foundation models.',
  },
  {
    icon: Network,
    title: 'Multi-agent execution',
    desc: 'Orchestrated via IBM Bee and LangChain agent frameworks.',
  },
  {
    icon: ShieldCheck,
    title: 'Enterprise-grade trust',
    desc: 'Governed, auditable, and secure AI pipelines end to end.',
  },
]
