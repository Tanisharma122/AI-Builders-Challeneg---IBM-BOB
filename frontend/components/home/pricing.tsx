...
const tiers = [
  {
    ...
    features: ['5 video imports / mo', 'Basic auto-clipping', '10 AI thumbnails', 'Single platform export'],
    cta: 'Start Free',
    featured: false,
  },
  {
    ...
    price: '$39',
    cadence: '/mo',
    desc: 'For growing channels shipping daily.',
    features: [
      'Unlimited video imports',
      'Advanced hook detection',
      'Unlimited thumbnails & B-roll',
  ...
  },
  {
    ...
    features: ['Everything in Pro', 'Team workspaces & roles', 'Custom agent workflows', 'Dedicated support & SLA'],
    cta: 'Contact Sales',
    featured: false,
  },
]
    ...
    <section id="pricing" className="mx-auto max-w-7xl px-6 py-20 lg:py-28">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <h2 className="mt-4 text-balance text-3xl font-bold tracking-tight text-foreground sm:text-4xl">
          Flexible plans that scale with your content.
        </h2>
      </div>
